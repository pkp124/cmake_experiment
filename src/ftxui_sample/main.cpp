...
// configuration step. It creates a namespace called `cmake_experiment`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_experiment::cmake::project_name, cmake_experiment::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_experiment::cmake::project_version);
      return EXIT_SUCCESS;
    }
